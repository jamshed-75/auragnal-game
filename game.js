...
setTimeout(() => tryAgainBtn.classList.remove("hidden"), 800);
...
mobileUp.ontouchstart = () => player.jump();
mobileLeft.ontouchstart = () => player.moveLeft();
mobileRight.ontouchstart = () => player.moveRight();
