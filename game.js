...
// Tap + Hold mobile controls
let leftHeld, rightHeld;
mobileUp.addEventListener("touchstart", () => player.jump());
mobileLeft.addEventListener("touchstart", () => {
leftHeld = setInterval(() => player.moveLeft(), 30);
});
mobileLeft.addEventListener("touchend", () => clearInterval(leftHeld));
mobileRight.addEventListener("touchstart", () => {
rightHeld = setInterval(() => player.moveRight(), 30);
});
mobileRight.addEventListener("touchend", () => clearInterval(rightHeld));
